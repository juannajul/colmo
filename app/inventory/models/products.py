...
class ProductSizes(models.Model):
    ...
    size = models.CharField(max_length=20, verbose_name="Product size")
...
class Product(models.Model):
    ...
    store_price = models.DecimalField(max_digits=4, decimal_places=2)
    sale_price = models.DecimalField(max_digits=4, decimal_places=2, blank=True)
    is_active = models.BooleanField(default=True)
